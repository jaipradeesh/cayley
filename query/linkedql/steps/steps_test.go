			...
			map[string]interface{}{
				"@graph": []interface{}{
					map[string]interface{}{
						...
						"http://example.org/likes": map[string]interface{}{"@id": "http://example.org/bob"},
						"http://example.org/name":  "Alice",
					},
					map[string]interface{}{"@id": "http://example.org/bob", "http://example.org/likes": map[string]interface{}{"@id": "http://example.org/alice"}, "http://example.org/name": "Bob"}}}, map[string]interface{}{"@graph": []interface{}{map[string]interface{}{"@id": "http://example.org/alice", "http://example.org/likes": map[string]interface{}{"@id": "http://example.org/bob"}, "http://example.org/name": "Alice"}, map[string]interface{}{"@id": "http://example.org/bob", "http://example.org/likes": map[string]interface{}{"@id": "http://example.org/alice"}, "http://example.org/name": "Bob"}}}},
	},
	{
		name: "Context",
		data: []quad.Quad{
